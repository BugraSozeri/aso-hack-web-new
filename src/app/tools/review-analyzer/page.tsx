...
import { Star, Bell, ArrowRight, CheckCircle2 } from "lucide-react";
...
export const metadata: Metadata = {
  ...
  description:
    "AI-powered app review sentiment analysis. Understand what users love and hate, extract themes and trends from App Store and Google Play reviews.",
};
...
export default function ReviewAnalyzerPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-20 sm:px-6 lg:px-8 text-center">
      ...
      <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Review Analyzer</h1>
      <p className="mt-4 text-lg text-muted-foreground max-w-xl mx-auto">
        AI-powered sentiment analysis for App Store and Google Play reviews.
        Understand what users love and hate — before your competitors do.
      </p>
      ...
      <Card className="mt-10 text-left">
        <CardContent className="p-6 space-y-3">
          ...
          {[
            ...
            "Top themes and pain points extracted automatically",
            "Star rating trend analysis over time",
