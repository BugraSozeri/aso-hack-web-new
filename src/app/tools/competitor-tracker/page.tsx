...
import { Users, Bell, ArrowRight, CheckCircle2 } from "lucide-react";
...
export const metadata: Metadata = {
  ...
  description:
    "Monitor competitor app rankings, ratings, review velocity, and keyword strategies. Daily snapshots and alerts for App Store and Google Play.",
};
...
export default function CompetitorTrackerPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-20 sm:px-6 lg:px-8 text-center">
      ...
      <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Competitor Tracker</h1>
      <p className="mt-4 text-lg text-muted-foreground max-w-xl mx-auto">
        Monitor your competitors&apos; app rankings, ratings, and keyword strategies.
        Get daily snapshots and instant alerts when something changes.
      </p>
      ...
      <Card className="mt-10 text-left">
        <CardContent className="p-6 space-y-3">
          ...
          {[
            "Daily rank tracking across App Store and Google Play",
            "Rating and review velocity monitoring",
            "Keyword overlap and gap analysis",
            "Listing change detection (screenshots, description, etc.)",
            "Email alerts for significant competitor changes",
          ].map((f) => (
